...
export const dictionaries: Record<Locale, Dictionary> = {
  ...
  fr: {
    auth: {
      layoutSubtitle: 'Créez des visites virtuelles 360° impressionnantes',
      login: {
        title: 'Bon retour',
        emailLabel: 'Email',
        ...
        welcomeBackToast: 'Heureux de vous revoir !',
      ...
      register: {
        ...
        errors: {
          ...
          accountCreated: 'Compte créé ! Bienvenue sur BATIVY',
          genericError: 'Une erreur est survenue. Veuillez réessayer.',
        },
      },
    },
    home: {
      ...
      hero: {
        titlePrefix: 'Créez des',
        titleHighlight: 'visites virtuelles 360°',
        titleSuffix: 'en quelques minutes',
        description:
          "BATIVY vous permet de créer, personnaliser et partager facilement des visites virtuelles 360° immersives. Idéal pour l'immobilier, l'hôtellerie, le tourisme et plus encore.",
        ...
        cards: [
          {
            ...
            description:
              "Importez vos images 360° avec une interface glisser-déposer simple. Prise en charge de plusieurs formats.",
          },
          {
            title: 'Éditeur interactif',
            description:
              "Ajoutez des hotspots, des liens et des points d'information pour créer des expériences immersives.",
          },
          {
            title: 'Partage partout',
            description:
              "Générez des liens partageables et du code d'embarquement. Parfait pour les sites web et les réseaux sociaux.",
          },
          {
            title: "Collaboration d'équipe",
            description:
              'Invitez des membres et collaborez en temps réel sur vos projets.',
          },
        ],
      },
      pricing: {
        ...
        tiers: {
          ...
          professional: {
            ...
            cta: 'Commencer',
            features: [
              '5 à illimitées de visites virtuelles',
              'Plusieurs scènes par visite',
              "De 1 à illimitées de membres d'équipe",

            ],
          },
          enterprise: {
            name: 'Enterprise',
            subtitle: 'Pour les opérations à grande échelle',
      ...
      cta: {
        title: 'Prêt à créer votre première visite ?',
        description: "Démarrez votre essai gratuit de 14 jours. Aucune carte bancaire requise.",
