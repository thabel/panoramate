  ...
  try {
    ...
    const toursQuery = `
      SELECT
        ...
        ti.folder as firstImage_folder,
        ti.previewUrl as firstImage_previewUrl,
        ti.tileBaseUrl as firstImage_tileBaseUrl,
        ti.levels as firstImage_levels,
    ...
    const tours = toursRaw.map((row: any) => ({
      ...
      images: row.firstImage_id ? [{
        ...
        folder: row.firstImage_folder,
        previewUrl: row.firstImage_previewUrl,
        tileBaseUrl: row.firstImage_tileBaseUrl,
        levels: typeof row.firstImage_levels === 'string' ? JSON.parse(row.firstImage_levels) : row.firstImage_levels,
